package sg.edu.rp.c346.id22012732.demoweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    ListView lvWeather; // Declaration of the ListView variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // onResume() method should be separate, not nested within onCreate()
    }
